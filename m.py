...
\033[1;97m ╔══════════════════════════════════════╗   
 ...
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║\033[1;95mOwner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mFX ARIYAN ISLAM \033[1;90m<\033[1;92m•\033[1;90m] \033[1;95mV-01\033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
contactinfo = (""" 
\033[1;97m ╔══════════════════════════════════════╗   
 ...
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║   \033[1;95m Owner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mFX ARIYAN ISLAM    \033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
def Cloning_Linex():
...
def Contact():
	...
	if Tymin in ['2']:
		os.system('xdg-open https://www.facebook.com/copy.link.erorr404')
	if Tymin in ['3']:
		os.system('xdg-open https://facebook.com/copy.link.erorr404/')
	if Tymin in ['4']:
		os.system('xdg-open https://facebook.com/copy.link.erorr404/')
	if Tymin in ['5']:
		os.system('xdg-open https://chat.whatsapp.com/copy.link.erorr404')
	if Tymin in ['6']:
		os.system('xdg-open wa.me/+copy.link.erorr404')
	if Tymin in ['7']:
		os.system('xdg-open t.me/copy.link.erorr404')
	if Tymin in ['8']:
		os.system('xdg-open https://github.com/copy.link.erorr404')
	if Tymin in ['9']:
		Nodi_Hasan()
	if Tymin in ['0']:
